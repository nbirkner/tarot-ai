  ...
  return (
    <div className="space-y-6 max-w-2xl mx-auto">
      ...
      >
        ...
        {state.overallEnergy ? (
          <p style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 20, lineHeight: 1.75, fontStyle: 'italic', color: headingColor }}>
            {state.overallEnergy}
        ...
        return (
          ...
          >
            ...
            <div style={{ marginBottom: 10 }}>
              ...
              <p style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 14, fontStyle: 'italic', color: isDark ? 'rgba(248,244,239,0.45)' : 'var(--brown-light)' }}>
                {drawn.position}
              </p>
            </div>
            ...
            {hasInterpretation ? (
              <p style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 18, lineHeight: 1.72, color: bodyColor }}>
      ...
      {showSynthesis && (
        ...
        >
          ...
          {state.synthesis ? (
            <p style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 19, lineHeight: 1.72, color: isDark ? 'rgba(248,244,239,0.85)' : 'var(--brown-dark)' }}>
              {state.synthesis}
      ...
      {state.notableTiming && (
        <motion.p
          ...
          style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 16, fontStyle: 'italic', color: isDark ? 'rgba(248,244,239,0.45)' : 'var(--brown-light)' }}
        >
          ☽ {state.notableTiming}
        </motion.p>
      )}
